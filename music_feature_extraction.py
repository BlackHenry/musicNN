...
track_features = sp.audio_features('https://open.spotify.com/track/0PHwCbA310LLIMcSDpQbgF')
...
genre_name = genre_data[genre_data['genre_id'] == genre_ids[predicted_genre]]['genre_title'].values[0]
